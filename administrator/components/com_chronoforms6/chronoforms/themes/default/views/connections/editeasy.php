...
<form action="<?php echo r2('index.php?ext=chronoforms&cont=connections'); ?>" method="post" name="admin_form" id="admin_form" class="ui form">
	...
	<div class="ui">
		<button type="button" class="ui button compact green icon labeled toolbar-button" name="save" data-url="<?php echo r2('index.php?ext=chronoforms&cont=connections&act=edit&easy=1'); ?>">
			<i class="check icon"></i><?php el('Save'); ?>
		</button>
		<button type="button" class="ui button compact blue icon labeled toolbar-button" name="apply" data-url="<?php echo r2('index.php?ext=chronoforms&cont=connections&act=edit&easy=1'); ?>">
				...
				<div class="ui fluid vertical steps small G2-tabs">
					<?php if(!empty($this->data['Connection']['functions'])): ?>
						...
						<?php foreach($this->data['Connection']['functions'] as $function_n => $function): ?>
							...
							?>
							<a class="step <?php if(empty($counter)): ?>active<?php endif; ?>" style="<?php echo $style; ?>" data-tab="function-<?php echo $function_n; ?>">
			...
			<div class="twelve wide column events-data">
				<?php if(!empty($this->data['Connection']['functions'])): ?>
					...
					<?php foreach($this->data['Connection']['functions'] as $function_n => $function): ?>
						...
						?>
						<div class="ui tab segment <?php if(empty($counter)): ?>active<?php endif; ?>" style="<?php echo $style; ?>" data-tab="function-<?php echo $function_n; ?>">

	...
	<div class="ui bottom attached tab segment active" data-tab="functions-<?php echo $n; ?>-general">
		...
		<div class="ui segment active" data-tab="functions-<?php echo $n; ?>">
			...
			<div class="field">
				...
				<textarea placeholder="" name="Connection[functions][<?php echo $n; ?>][body]" rows="10" data-editor="email" data-eheight="400" id="email_editor<?php echo $n; ?>"></textarea>
			...
			<div class="ui header dividing small"><?php el('Attachments settings'); ?></div>
			<div class="field forms_conf">
				<div class="ui checkbox toggle">
			...
			<div class="ui header dividing small"><?php el('Send settings'); ?></div>
			...
			<div class="two fields">
				...
				<div class="field private_config">
					...
					<input type="text" value="<?php echo \G2\L\Config::get('mail.from_email'); ?>" name="Connection[functions][<?php echo $n; ?>][from_email]">
					<small style="color:red;"><?php el('This field is required, and in most cases it must be address@YOURdomain.xyz'); ?></small>
				</div>
				
				<div class="field">
					<label><?php el('From name'); ?></label>
					<input type="text" value="<?php echo \G2\L\Config::get('mail.from_name'); ?>" name="Connection[functions][<?php echo $n; ?>][from_name]">
				</div>

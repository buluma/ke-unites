...
<div class="ui segment tab functions-tab active" data-tab="functions-<?php echo $n; ?>">
	...
	<div class="ui top attached tabular menu small G2-tabs">
		...
		<a class="item" data-tab="functions-<?php echo $n; ?>-external"><?php el('External database'); ?></a>
	...
	<div class="ui bottom attached tab segment active" data-tab="functions-<?php echo $n; ?>-general">
		...
		<div class="ui pointing menu G2-tabs inverted models-menu">
			<a class="item active" data-tab="functions-<?php echo $n; ?>-models-0"><?php echo !empty($function['model_name']) ? $function['model_name'] : rl('Primary'); ?></a>
			<?php if(!empty($function['models'])): ?>
				<?php foreach($function['models'] as $model_number => $model): ?>
					<a class="item" data-tab="functions-<?php echo $n; ?>-models-<?php echo $model_number; ?>"><?php echo $model['model_name']; ?></a>
				<?php endforeach; ?>
			<?php endif; ?>
		</div>
		...
		<div class="ui tab segment active" data-tab="functions-<?php echo $n; ?>-models-0">
			...
			<div class="three fields">
				...
				<div class="two wide field">
					...
					<input type="text" value="" name="Connection[functions][<?php echo $n; ?>][limit]">
				</div>
			</div>
	...
	<div class="ui bottom attached tab segment" data-tab="functions-<?php echo $n; ?>-external">

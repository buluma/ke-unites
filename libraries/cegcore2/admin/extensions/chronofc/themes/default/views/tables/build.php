...
?>
<form action="<?php echo r2('index.php?ext=chronofc&cont=tables'); ?>" method="post" name="admin_form" id="admin_form" class="ui form">
	
	<h2 class="ui header"><?php el('Build table'); ?></h2>
	<div class="ui">
		<a class="compact ui button red icon labeled toolbar-button" href="<?php echo r2('index.php?ext=chronofc&cont=connections'); ?>">
			<i class="left arrow icon"></i><?php el('Cancel'); ?>
		</a>
		
		<button type="button" class="compact ui button green icon labeled toolbar-button" data-url="<?php echo r2('index.php?ext=chronofc&cont=tables&act=build'); ?>">
			<i class="refresh icon"></i><?php el('Refresh'); ?>
		</button>
		
		<button type="button" class="compact ui button black icon labeled toolbar-button" data-url="<?php echo r2('index.php?ext=chronofc&cont=tables&act=build&save=1'); ?>" id="save_button">

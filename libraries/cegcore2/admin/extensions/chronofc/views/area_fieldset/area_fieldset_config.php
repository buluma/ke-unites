...
<div class="ui segment tab views-tab active" data-tab="views-<?php echo $n; ?>">
	...
	<div class="ui bottom attached tab segment active" data-tab="views-<?php echo $n; ?>-general">
		<input type="hidden" value="area_fieldset" name="Connection[views][<?php echo $n; ?>][type]">
		...
		<div class="two fields">
			<div class="six wide field">
				...
				<input type="text" value="area_fieldset_<?php echo $n; ?>" name="Connection[views][<?php echo $n; ?>][id]">
			</div>
		...
		<div class="field">
			...
			<input type="text" value="Fieldset..." name="Connection[views][<?php echo $n; ?>][legend]">
		</div>

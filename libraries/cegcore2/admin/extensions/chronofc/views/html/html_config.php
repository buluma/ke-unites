...
<div class="ui segment tab views-tab active" data-tab="views-<?php echo $n; ?>">
	...
	<div class="ui bottom attached tab segment active" data-tab="views-<?php echo $n; ?>-general">
		...
		<div class="field">
			...
			<textarea placeholder="<?php el('HTML or PHP Code with tags'); ?>" name="Connection[views][<?php echo $n; ?>][content]" rows="20" data-editor="1" id="html_editor<?php echo $n; ?>"></textarea>
		</div>
	</div>

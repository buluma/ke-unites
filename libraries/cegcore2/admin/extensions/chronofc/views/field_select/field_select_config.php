	...
	<div class="ui bottom attached tab segment active" data-tab="views-<?php echo $n; ?>-general">
		...
		<div class="two fields">
			<div class="twelve wide field">
				...
				<input type="text" value="Dropdown" name="Connection[views][<?php echo $n; ?>][label]">
			</div>
		...
		<div class="two fields">
			<div class="field">
				<label><?php el('Name'); ?></label>
				<input type="text" value="select<?php echo $n; ?>" name="Connection[views][<?php echo $n; ?>][params][name]">
			...
			<div class="field">
				...
				<input type="text" value="select<?php echo $n; ?>" name="Connection[views][<?php echo $n; ?>][params][id]">
			</div>
		</div>
